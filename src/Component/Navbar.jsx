    ...
    <nav className="mx-auto max-w-7xl px-8 2xl:max-w-screen-2xl py-4 absolute top-0 left-0 right-0 text-white z-10 bg-primary md:bg-transparent sm:bg-primary lg:bg-transparent xl:bg-transparent">
      <div className=" mx-auto flex items-center justify-between">
        ...
        <Link to="aboutus" className="rtl:mr-4 ltr:ml-4">
          <button
            className="bg-main rounded-[16px] text-white xsmall:bg-red-600 xsmall:text-white sm:bg-main sm:text-white lg:bg-base lg:text-main xl:bg-base xl:text-main"
            style={{
              padding: '16px 24px',
              fontWeight: '500',
              border: 'none',
